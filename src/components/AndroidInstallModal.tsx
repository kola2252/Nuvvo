...
# 3. Build Web Bundle & Sync Android Project
npm run build
npx cap add android
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-120 flex items-center justify-center p-4 bg-black/65 backdrop-blur-sm animate-fadeIn">
        ...
        >
          ...
          {/* Navigation Tabs */}
          <div className="flex border-b border-slate-100 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-950/60 p-1.5 gap-1.5">
            <button
